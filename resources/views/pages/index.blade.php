            ...
            <section class="section section-lg section-shaped pb-250">
                ...
                <div class="container py-lg-md d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">RHEA
                                    <span><small>In partnership with Kasaju Medical and Multispecialty Clinic</small></span>
                                </h1>
...
{{--<div class="container">--}}
{{--<h1>Welcome to RHEA!</h1>--}}
{{--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam eu metus ac ligula vehicula sagittis. Vivamus porttitor facilisis porttitor.</p>--}}
